	...
	,	getRecordShippingMethods: function ()
		{
			...
			{
				var shipping_rate = this.record.getFieldValue('altshippingcost') ? this.record.getFieldValue('altshippingcost') : this.record.getFieldValue('shipping_rate');
				...
				,	name: this.record.getFieldText('shipmethod')
					//@property {Number} rate
				,	rate: Utils.toCurrency(shipping_rate)
					//@property {String} rate_formatted
				,	rate_formatted: Utils.formatCurrency(shipping_rate, self.result.selected_currency ? self.result.selected_currency.symbol : undefined)
