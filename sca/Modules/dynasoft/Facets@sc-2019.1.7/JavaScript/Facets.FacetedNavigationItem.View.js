	...
	,	initialize: function ()
		{
			...
			//18/07/2019 Saad
			if(this.facet_config.name=="custitem_clothing_type")
			{
				this.navbarname="Category";
			}
			else if(this.facet_config.name=="custitem_fabric_color"){
				this.navbarname="Fabric Design";
			}
			else if(this.facet_config.name=="custitem_vendor_name")
			{
				this.navbarname="Brand";
			}
			else
			{
				this.facet_config.name=this.facet_config.name;
			}
		}
