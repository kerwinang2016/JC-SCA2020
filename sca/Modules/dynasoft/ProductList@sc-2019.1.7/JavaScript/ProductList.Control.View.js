		...
		)
{
	...
	,	addItemToList: function (line, productList, dontShowMessage)
		{
			// if (line.isValid(true)) //Commented salman 7-july-2019
			// {
				var self = this;
	...
	,	showFlyout: function (e)
		{
			...
			// if (this.product.areAttributesValid(['options','quantity'], {})) //commented Salman 7-july-2019
			// {
	...
	,	getContext: function()
		{
			...
			,	hideNewProductList:(window.location.href.indexOf('wishlist')!=-1 && window.location.href.indexOf('my_account')!=-1)
			};
		}
	});
});
