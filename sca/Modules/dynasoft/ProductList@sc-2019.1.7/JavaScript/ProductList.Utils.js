	...
	)
{
	...
	return function (application)
	{
						...
						,	name: function ()
							{
								...
								return utils.isSingleList() ?
									...
									_('Product List').translate(); // zain 26-08-19
							}
						,	url: function ()
							{
		...
		,	// @method getFilteredProductList obtain a filtered ProductList with all its item's data @return {ProductList.Model}
			getFilteredProductList : function (filtersObj)
			{
				var productList = new ProductListModel();
				productList.set('internalid', 'later');
				return productList.fetch({ data: { custom_filters_object: filtersObj}});
			}
