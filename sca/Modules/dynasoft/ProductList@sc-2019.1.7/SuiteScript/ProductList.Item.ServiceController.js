		...
		,	getUser: function()
			{
				...
				,	user = profile.parent;//nlapiGetUser();
		...
		,	post: function()
			{
				...
				var newData = ProductListItemModel.create(user, this.data);
				this.sendContent(ProductListItemModel.get(user, newData.internalid), {'status': 201});
			}
