	...
	)
{
	...
	,	sendError: function (e)
		...
		,	getAllPaginatedSearchResults: function (options)
		{
			'use strict';
	...
	,	getSearchFilterArray: function ()
		{
			...
			if (false //Added false because we dont want to use the multisite feature
				&& ModelsInit.context.getFeature('MULTISITE') && site_id && filter_site.option && 'all' !== filter_site.option)
			{
