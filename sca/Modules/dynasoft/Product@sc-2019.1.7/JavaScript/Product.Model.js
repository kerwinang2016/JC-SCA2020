	...
	)
{
	...
	var ProductModel = Backbone.Model.extend(
		...
		,	getPrice: function getPrice ()
			...
			//@method get Design Options configurations, Design Restriction and favourite Options
			//@return {dataObj}
		,	getUserOptionConfiguration: function getUserOptionConfiguration() //get d
		{
			var self = this,
				dataObj = new Object();
			...
			jQuery.get(urlDesignOptions).done(function (data) {
				...
				dataObj.options_config = options_config;
				dataObj.designRestrictions = JSON.parse(JSON.parse(self.profile_model.get('designoptionRestrictionData')));
				dataObj.favouriteOptions =  JSON.parse(JSON.parse(self.profile_model.get('favouriteOptionsData')));
			});
			return dataObj;
