	...
	,	childViews: {
		...
		, _buildResultsView: function() {			
					...
					if(!Configuration.get().transactionListColumns.enableInvoice) {
						...
						selectedColumns.push({label: 'Customer:', type:'customer', name:'customer', id:'custbody_customer_name'});
						selectedColumns.push({label: 'Type:', type:'type', name:'type', id:'customer_name_type'});
					} else {
