	...
	,	getContext: function ()
		{
			...
			var donwloadPdfUrl = "https://" + window.location.hostname + "/app/site/hosting/scriptlet.nl?script=121&deploy=1&compid=3857857&h=a10878b386852988f44f&custparam_record_id=" + this.model.get('internalid') + "&custparam_record_type=invoice&custparam_template=4"
			...
			return {
				...
				,	customer_name: this.model.get('custbody_customer_name')  //30/08/2019 Saad SAAD
				,	created_by:	this.model.get('custbody_so_created_by')	//30/08/2019 Saad SAAD
			};
		}
	});
});
