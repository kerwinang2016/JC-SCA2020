	...
	)
{
	...
	, _buildResultsView: function() {
			...
			if(!Configuration.get().transactionListColumns.enableInvoice) {
				...
				selectedColumns.push({label: 'Order:', type:'order', name:'order', id:'createdfrom'});	//11/09/2019 Saad saad
				selectedColumns.push({label: 'Customer:', type:'customer', name:'customer', id:'custbody_customer_name'});  //06/09/2019 Saad
				selectedColumns.push({label: 'Type:', type:'type', name:'type', id:'customer_name_type'});	//06/09/2019 Saad
			} else {
