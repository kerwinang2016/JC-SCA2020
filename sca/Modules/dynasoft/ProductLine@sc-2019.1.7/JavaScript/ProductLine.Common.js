	...
	,	extendOptionsFromItem: function extendOptionsFromItem (item, productline)
		{
			...
			// console.log(item.get('options'));
			// console.log('product options');
			// console.log(productline.get('options'));
			item.get('options').each(function (item_option)
			{
				...
				if(item_option.get('cartOptionId')){
					//console.log("item_option.get('cartOptionId') " + item_option.get('cartOptionId'));
					...
					,	productline_option = productline.get('options').find(function (product_option)
						{
							//console.log("product_option.get('cartOptionId') " + product_option.get('cartOptionId'));
