	...
	)
{
	...
	return Backbone.View.extend({
		...
		,	validateTextArea: function(){
			var value = $('#designoption-message').val();
			if(!Utils.validateText(value)){ // regex to allow only alphanumeric in textarea
				Utils.displayModalWindow("Error", _('Description shouldn\'t contain any special characters.').translate(), true);
				$('#designoption-message').val(value.substring(0, value.length-1));
			}
		} // -End-
