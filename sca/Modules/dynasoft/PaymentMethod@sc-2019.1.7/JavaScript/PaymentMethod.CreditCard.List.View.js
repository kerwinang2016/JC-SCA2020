	...
	)
{
	...
	,	getPaymentMethodsToShow: function ()
	{
		...
		for(var i =0; i < payment_methods_to_show.models.length; i++){ //To removed -1 id credit card
			if(payment_methods_to_show.models[i].id == '-1'){
				payment_methods_to_show.models.splice(i, 1);
			}
		}
