	...
	)
{
	...
	,	cart_items_non_shippable_options_right = _.extend(
			...
			,	show_edit_cart_button: false // 19/11/2019 Umar Zulfiqar {RFQ: Remove Edit Button on Show Shipments}
			}
	...
	return [
		...
		,	steps: [
				...
				,	modules: [
						...
						,	[OrderWizardModuleTitle, {title: _('').translate()}] // zain 20-12-19						
						,	[OrderWizardModulePaymentMethodSelector,  {record_type:'salesorder', prevent_default: true}]
						,	[OrderWizardModulePaymentMethodGiftCertificates]
						,	OrderWizardModulePaymentMethodPurchaseNumber
						,	[OrderWizardModuleAddressBilling, {title: _('').translate(), enable_same_as: function () { return !this.wizard.model.get('ismultishipto') && this.wizard.model.shippingAddressIsRequired();}}] // zain 20-12-19 remove 'billing address' title
						,	OrderWizardModuleRegisterEmail
