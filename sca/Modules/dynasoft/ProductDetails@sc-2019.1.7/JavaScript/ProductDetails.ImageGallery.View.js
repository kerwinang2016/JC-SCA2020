	...
	,	getContext: function ()
		{
			var blankimage = {};
			if(this.images[0]){
			   blankimage = this.images[0]; //13/09/2019 saad
			   blankimage.url = blankimage.url.replace('no_image_available', 'no_image_available_blank'); //13/09/2019 saad
			...
			,	firstImage: blankimage //13/09/2019 saad 
