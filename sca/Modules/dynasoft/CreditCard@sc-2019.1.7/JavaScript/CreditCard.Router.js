	...
	,	creditCardDetailed: function (id)
		{
			...
			model.on('reset destroy change add', function ()
			{
				...
				{
					view.$containerModal.removeClass('fade').modal('hide').data('bs.modal', null);
					view.destroy();
				}
				else
				{
	...
	,	newCreditCard: function ()
		{
			...
			collection
				.on('add', function ()
				{
					if (view.inModal)
					{
						view.$containerModal && view.$containerModal.removeClass('fade').modal('hide').data('bs.modal', null);
						view.destroy();
					}
					else
					{
