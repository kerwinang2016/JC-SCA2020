<!-- 6/20/2019 -->
<!-- <style>           
.facets-facet-browse{margin: 0;width: 100%;}
.facets-facet-browse-facets{display: block !important;float: left;}
.facets-facet-browse-results{width: 75%;}

</style> -->
<style>
	.facets-facet-browse-items{clear: both;}
	.facets-facet-browse-results .facets-facet-browse-pagination{padding-bottom: 10px;}
</style>
{{#if hasCategories}}
