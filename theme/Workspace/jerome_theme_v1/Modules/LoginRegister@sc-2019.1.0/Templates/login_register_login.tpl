<style>
body{background: linear-gradient(to bottom, #f9f9f9 0%, #ffffff 50%, #ffffff 50%, #ffffff 100%);} label{font-size: 12px;margin-bottom: 0;} #site-footer{display: none;} 
</style>
<h2 class="login-register-login-title">{{translate 'Returning user'}}</h2>
<p class="login-register-login-description">
	...
	{{else}}
		{{translate 'Sign in below with an existing account:'}}
	{{/if}}
</p>
	...
	<fieldset class="login-register-login-form-fieldset">
		<div class="login-register-login-form-controls-group" data-validation="control-group">
			<label class="login-register-login-form-label" for="login-email">
				...
				{{translate 'Email Address <small style="font-size:78%" class="login-register-login-required">(required)</small>'}}
			</label>
		...
		<div class="login-register-login-form-controls-group" data-validation="control-group">
			<label class="login-register-login-form-label" for="login-password">
				{{translate 'Password <small style="font-size:78%" class="login-register-login-required">(required)</small>'}}
			</label>
			<div class="login-register-login-form-controls" data-validation="control">
