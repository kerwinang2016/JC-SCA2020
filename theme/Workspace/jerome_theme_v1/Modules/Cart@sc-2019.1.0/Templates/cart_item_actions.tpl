<div class="cart-item-actions-links">
	{{#if isAdvanced}}
		...
		<a class="cart-item-actions-item-list-actionable-copy-content" data-action="copy-to-cart" data-internalid="{{lineId}}">
			{{translate 'Copy'}}
		</a> 
		...
		{{/if}}
		<a class="cart-item-actions-item-list-actionable-fabric-content-change" href="{{changeFabricUrl}}" data-internalid="{{lineId}}">
			{{translate 'Change Fabric'}}
		</a>
	{{/if}}

	
	<!-- <a class="cart-item-actions-item-list-actionable-copy-content" data-action="" data-internalid="">
		{{translate 'Copy'}}
	</a> 
	<a class="cart-item-actions-item-list-actionable-fabric-content-change" data-action="" data-internalid="">
		{{translate 'Change Fabric'}}
	</a>   -->
