<form method="POST">
	<div class="product-list-edit-item-modal-body" itemscope itemtype="https://schema.org/Product">
		...
		<div class="product-list-edit-item-details">
			...
			<div class="product-list-edit-item-quantity">
				...
				<input class="product-list-edit-item-input-quantity" name="custcol_fabric_quantity" id="quantity" value="{{quantity}}" min="1" readonly="">
			</div>
	...
	<div class="product-list-edit-item-modal-footer">
		...
		<button type="submit" class="product-list-edit-item-button-edit" data-action="edit">{{translate 'Save'}}</button>
	</div>
</form>
