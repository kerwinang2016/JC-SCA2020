<tr class="{{#if isChecked}}active{{/if}}" data-id="{{lineId}}" data-item-id="{{itemId}}" data-action="product-list-item">
	...
	<td class="product-list-display-full-actions">
		...
		{{#if showEdit}}
			<!-- <button class="product-list-display-full-edit" data-action="edit-item" data-toggle="show-in-modal" style="margin-bottom: 10px !important;">{{translate 'Order'}}</button><br> -->
				<button class="product-list-display-full-edit" data-action="place-order" style="margin-bottom: 10px !important;" {{#unless clientID}}disabled{{/unless}}>{{translate 'Order'}}</button><br>
			{{/if}}
			<button class="product-list-display-full-edit" href="#" data-action="delete-item" style="margin-bottom: 0px !important;">{{translate 'Delete'}}</button>
		{{#if showMoveAction}}
