	...
	<td class="product-list-list-details-actions">
		...
		{{#unless isTypePredefined}}
			...
			<div class="product-list-list-details-button-group">
					<a class="product-list-list-details-button-delete product-list-list-details-button-edit" href="#" data-action="delete-list">{{translate 'Delete List'}}</a>
				<!-- <button class="product-list-list-details-button-edit" data-action="edit-list">{{translate 'Edit List'}}</button> -->
				<a class="product-list-list-details-button-delete product-list-list-details-button-edit" href="/wishlist/{{#if internalId}}{{internalId}}{{else}}tmpl_{{templateId}}{{/if}}">{{translate 'View List'}}</a>
