...
<!-- 30/08/2019 saad -->
<p class="invoice-details-header-created-by-info">
	<span class="invoice-details-header-due-date-label">{{translate 'Created by: '}}</span>
	<span class="invoice-details-header-due-date-value">{{created_by}}</span>

</p>

<p class="invoice-details-header-customername-info">

	<span class="invoice-details-header-due-date-label">{{translate 'Customer name: '}}</span>
	<span class="invoice-details-header-due-date-value">{{customer_name}}</span>
</p>
<!-- 30/08/2019 saad -->
					...
					<div class="invoice-details-accordion-divider">
						<div class="invoice-details-accordion-head">
							<a class="invoice-details-accordion-head-toggle collapsed" data-toggle="collapse" data-target="#invoice-details-products" aria-expanded="true" aria-controls="invoice-details-products">{{#if linesLengthGreaterThan1}}
									{{translate 'Items' lines.length}} <!--zain 13-09-19 -->
							{{else}}
								{{translate 'Item' lines.length}} <!--zain 13-09-19 -->
							{{/if}}
							...
							<div data-content="items-body">
									<table class="invoice-details-products-table lg2sm-first">
										<thead class="invoice-details-table-products-header">
											...
											<th class="invoice-details-table-products-header-description">{{translate 'Description'}}</th><!--zain 11-09-19-->
