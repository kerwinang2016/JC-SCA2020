<div class="order-wizard-cart-summary-container">
	<h3 class="order-wizard-cart-summary-title" style="text-align: center;">
		<!-- zain (26-06-19) start -->
	{{translate 'Order Summary'}} 
	<!-- <div class="order-wizard-cartitems-module-ship-edit-cart-link-container" style="float: right;margin: 0;margin-top: -5px;">
				<a href="#" class="order-wizard-cartitems-module-ship-edit-cart-link" data-action="edit-module" data-touchpoint="viewcart">
					{{translate 'Edit Order'}}<i style="padding-left:8px;" class="fa fa-pencil"></i>
				</a>
			</div> -->
<!-- zain (26-06-19) end -->
</h3>
