<div class="reorder-items-actions-quantity">
	{{#if showQuantityInput}}
		<label class="reorder-items-actions-quantity-label">{{translate 'Qty:'}}</label><br>
...
{{#if showLastPurchased}}
	<p class="reorder-items-actions-quantity-last-purchased">{{translate 'Last purchased on <br> $(0)' line.trandate}}</p>
{{/if}}
