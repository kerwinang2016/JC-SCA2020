<tr class="transaction-line-views-cell-navigable {{cellClassName}} item-{{itemId}}" data-id="{{itemId}}" data-item-type="{{itemType}}">
	...
	<!-- 11-09-19 start -->
	<td class="transaction-line-views-cell-navigable-item-description" name="item-description">
			<p>
				<span class="transaction-line-views-cell-navigable-item-description-label">{{translate 'Description:'}} </span>
				<div class="transaction-line-views-cell-navigable-item-description-value">{{description}}</div>
			</p>
		</td>
	<!-- 11-09-19 end -->
	<td class="transaction-line-views-cell-navigable-amount" name="item-amount">
		<p>
		{{currencSymbol}} {{customPrices}}
		</p>
	</td>
</tr>
...
<!-- <script>
	...
	var data = $('.transaction-line-views-cell-navigable-item-description-value').text();
	data = data.replace(/<br\s*\/?>/gi,"\n");//data.split('<br>');

	////for(var i=0; i<data.length; i++){
		$('.transaction-line-views-cell-navigable-item-description-value').append(data);
	//}
