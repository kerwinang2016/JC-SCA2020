...
<script>
	...
	$('body').on('click','.order-history-details-non-shippable-table .accordion-toggle',function(){
			$(this).addClass("collapse-accordian-test");
			$(this).next().addClass("collapse-accordian");
		});
	

	$('body').on('click','.order-history-details-non-shippable-table .collapse-accordian-test',function(){
		$(this).removeClass("collapse-accordian-test");
		$(this).next().removeClass("collapse-accordian");
