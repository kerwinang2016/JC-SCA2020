...
<section>
	<header>
		<h2 class="order-history-details-order-title" data-origin='{{originName}}'>
			<span class="order-history-details-order-title">Order #  </span> <!-- zain 26-08-19 -->
	...
	<div class="order-history-details-row">
		...
		<div class="order-history-details-content-col" style="width:100%;">
			...
			<div class="order-history-details-accordion-divider">
				<div class="order-history-details-accordion-head">
					<a class="order-history-details-accordion-head-toggle-secondary collapsed" data-toggle="collapse"
						data-target="#products-not-shipp" aria-expanded="true" aria-controls="products-not-shipp">
				...
				<div class="order-history-details-accordion-body collapse" id="products-not-shipp" role="tabpanel"
					data-target="#products-not-shipp">
			...
			<!-- <header style="margin-bottom:0;">
					<h2 class="order-history-details-order-title">
						<span class="order-history-details-order-title">Payment Information </span>
					</h2>
				</header>
			{{#if showPaymentMethod}}
						<div class="order-history-details-payment-info-cards" style="width:66%;float:left;">
								{{#if showBillAddress}}
			...
			<div class="order-history-details-accordion-divider">
				<div class="order-history-details-accordion-head collapsed">
					<a class="order-history-details-accordion-head-toggle-secondary" data-toggle="collapse"
						data-target="#returns-authorizations" aria-expanded="true"
						aria-controls="returns-authorizations">
						{{translate '<span>Returns ($(0))</span>' returnAuthorizations.totalLines}}
						<i class="order-history-details-accordion-toggle-icon-secondary"></i>
					</a>
				</div>
				<div class="order-history-details-accordion-body collapse" id="returns-authorizations" role="tabpanel"
			...
			<div style="float: right;width: 33%;margin-left: 15px;" class="order-history-details-summary" data-view="Summary"></div> <!-- zain 26-08-19 --> <!-- zain 30-08-19 -->
			<!-- SUMMARY ENDS -->
			</div>
