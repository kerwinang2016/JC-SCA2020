...
<ul class="header-menu-myaccount">
	...
	<li class="header-menu-myaccount-item-level2 header-menu-myaccount-level2-orders" data-permissions="{{purchasesPermissions}}" data-permissions-operator="OR">
		...
		<ul class="header-menu-myaccount-level3 header-menu-myaccount-level3-orders">
			...
			<!-- zain 22-07-19 start -->
			<li data-permissions="{{purchasesPermissions}}">
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#cart" name="saveditems">
			...
			<!-- <li data-permissions="{{purchasesPermissions}}">  04/02/2020
			...
			<li class="header-menu-myaccount-item-level3" data-permissions="transactions.tranFind.1,transactions.tranEstimate.1">
				<a class="header-menu-myaccount-anchor-level3 quotes-menu" data-action="push-menu" href="#" data-touchpoint="customercenter" data-hashtag="#quotes" name="quotes"> <!-- zain 26-08-19 -->
					{{translate 'Quotes'}}
					<i class="header-menu-myaccount-menu-push-icon"></i>
				</a>
	...
	<li class="header-menu-myaccount-overview">
		...
		<a class="header-menu-myaccount-overview-anchor" href="#" data-touchpoint="customercenter" data-hashtag="#wishlist" name="productList"> <!--zain 30-08-19-->
	...
	<li class="header-menu-myaccount-item-level2">
		...
		<ul class="header-menu-myaccount-level3">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#designoptionsrestriction" name="designoptionsrestriction">
					{{translate 'Design Options Restriction'}}
				</a>
			</li>
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#favouriteoptions" name="favouriteoptions">
					{{translate 'Favourite Options'}}
				</a>
			</li>
			<li>
				<a class="header-menu-myaccount-anchor-level3" href="#" data-touchpoint="customercenter" data-hashtag="#favouritefittools" name="favouritefittools">
					{{translate 'Favourite Fit Tools'}}
				</a>
			</li>
		</ul>
	</li>
<!--	{{#if isCaseModuleEnabled}}
	...
	{{/if}} -->
	<li class="header-menu-myaccount-overview">
		<a class="header-menu-myaccount-overview-anchor" href="#" data-touchpoint="customercenter" data-hashtag="#fitprofile" name="fitprofile">
			{{translate 'Client Profiles'}}
		</a>
	</li>

<li class="header-menu-myaccount-item-level2" data-permissions="">
		<a  class="header-menu-myaccount-anchor-level2" tabindex="-1" href="#" data-action="push-menu" name="cases">
			{{translate 'Support'}}
			<span>&#8227;</span>
			<i class="header-menu-myaccount-menu-push-icon"></i>
		...
		<ul class="header-menu-myaccount-level3">
			...
			<li>
				<a class="header-menu-myaccount-anchor-level3" tabindex="-1" href="#" data-touchpoint="customercenter" data-hashtag="#trainingguides" name="trainingguides">{{translate 'Training Guides'}}</a>
			</li>
	...
	<li class="header-menu-myaccount-overview">
		<a class="header-menu-myaccount-overview-anchor" href="#" data-touchpoint="customercenter" data-hashtag="#stocklist" name="stocklist">
			{{translate 'Stock List'}}
		</a>
	</li>
<li class="header-menu-myaccount-overview">
		<a class="header-menu-myaccount-overview-anchor" href="#" data-touchpoint="customercenter" data-hashtag="#contactus" name="contactus">
			{{translate 'Contact Us'}}
		</a>
	</li>
	<li class="header-menu-myaccount-overview">
		<a class="header-menu-myaccount-overview-anchor" href="#" data-touchpoint="customercenter" data-hashtag="#termsandconditions" name="termsandconditions">
			{{translate 'Terms And Conditions'}}
		</a>
	</li>

	<li class="header-menu-myaccount-overview header-menu-signout">
