...
<a class="header-mini-cart-menu-cart-link {{#if showLines}}header-mini-cart-menu-cart-link-enabled{{/if}}" data-type="mini-cart" title="{{translate 'Cart'}}" data-touchpoint="{{cartTouchPoint}}" data-hashtag="#cart" href="#">
	...
	<span class="header-mini-cart-menu-cart-legend">
		{{#if isLoading}}
		<span class="header-mini-cart-summary-cart-ellipsis"></span>{{else}}{{translate '$(0)' itemsInCart}}{{/if}}<p> item</p></span></a>
<!-- zain 02-09-19 end -->
...
<!-- zain 02-09-19 start -->
<script>
var strOne = $( "span.header-mini-cart-menu-cart-legend" ).text();
	strOne = strOne.split(" ");
	var quantityItemOne = strOne[1];
	//var textItem = str[1];
var str = $( "span.header-mini-cart-menu-cart-legend" ).text();
str = str.split(" ");
var quantityItem = str[0];
//var textItem = str[1];
if(quantityItem == "\n0" || quantityItem == "\n1" || quantityItemOne == "0" || quantityItemOne == "1"){
	$(".header-mini-cart-menu-cart-legend p").html(" Item");
}
else{
	$(".header-mini-cart-menu-cart-legend p").html(" Items");
}
</script>
<!-- zain 02-09-19 end -->
